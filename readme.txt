...
3a. Edit CSS file in plugin folder. You must edit mm-bnlist.css if you want to display more than two columns.
4. In WordPress menu go to 'Setting / MM Breaking News' and configure plugin
